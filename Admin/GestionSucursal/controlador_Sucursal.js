        ...
        let obj = []; // arreglo que se llenará de objetos JSON
          ...
          var text = '{"sucursales":[ ' +
          '{ "usuario" :"Admin0","nomSuc" :"Sicefa Plaza Mayor", "nomTit"  : "Diego ", "rfc"  : "FC29D837", "domicilio"  : "calle orquídea  #108", "colonia"  : "Santa rosa ","ciudad"  : "Leon", "codigoPostal"  : "37680", "telefono"  : "4772902221","estado"  : "Guanajuato","longitud"  : "-12330","latitud"  : "-34567","estatus" : "Activo"},' +
          '{ "usuario" :"Admin1","nomSuc" :"Sicefa Centro", "nomTit"  : "Jimena ", "rfc"  : "HI35837", "domicilio"  : "Av orquídea  #108", "colonia"  : "Santa rosa ","ciudad"  : "Leon", "codigoPostal"  : "37680", "telefono"  : "4772902221","estado"  : "Guanajuato","longitud"  : "-12330","latitud"  : "-34567","estatus" : "Activo"},' +
          '{ "usuario" :"Admin9","nomSuc" :"Sicefa Centro Max", "nomTit"  : "Jonathan ", "rfc"  : "KD76KE07", "domicilio"  : "calle Independencia #1142", "colonia"  : "San Miguel ","ciudad"  : "Leon", "codigoPostal"  : "38690", "telefono"  : "4772956985","estado"  : "Guanajuato","longitud"  : "-36330","latitud"  : "-37567","estatus" : "Activo"}] }';
        ...
        function actualizaTabla() {
            ...
            obj.sucursales.forEach(function (nuevoProd) {
                ...
                '<td>' + obj.sucursales.indexOf(nuevoProd)  + '</td>' +
                 '<td>'+"Admin" + obj.sucursales.indexOf(nuevoProd)  + '</td>' +
        ...
        function searchSucursal() {
                    ...
                    let valor= document.getElementById("txtBusquedaSucursal").value;
